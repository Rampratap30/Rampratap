...
class RequestValidation:
    ...
    def validate(func):
        try:
                    ...
                    if "Authorization" not in request.headers:
                        ...
                        if token is None or token == "":
                            ...
                            if not token.startswith("Bearer"):
                                ...
                                raise ValueError("Missing Bearer in Authorization")
            ...
            raise ValueError("Request token validation error") from e
    ...
    def jwt_validation(token) -> bool:
        try:
            ...
            raise ValueError("JWT validation error") from e
    ...
    def validate_header(request) -> list:
        try:
            ...
            raise ValueError("validate_header error") from e
