...
@Component({
  selector: 'app-tmo-multiple-shipto',
  templateUrl: './tmo-multiple-shipto.component.html',
  styleUrls: ['./tmo-multiple-shipto.component.css'],
})
export class TmoMultipleShiptoComponent {
  order_status = {
    '1': 'Order Received',
    '2': 'In Process',
    '3': 'Scheduling',
