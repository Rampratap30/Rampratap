package com.banking.Rookie_approach;

public class BankSych {
    ...
    // withdrawal
    public static synchronized void withdrawn(String name,
                                       int withdrawal)
    {
        if (total >= withdrawal) {
    ...
    public static synchronized void deposit(String name,
                                     int deposit)
    {
