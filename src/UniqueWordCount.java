...
public class UniqueWordCount {
	...
	public static void main(String[] args) {
		...
		String aaa = "Middle English storie, from Medieval Latin historia narrative, illustration, story of a building, from Latin, history, tale; probably from narrative friezes on the window level of medieval buildings";
		String aa = "How are you, Where are you";
