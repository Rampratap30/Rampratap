...
DECLARE changeRecord
   CURSOR FOR 
	...
	IF (COALESCE(v_absence_start_date,'X') != COALESCE(v_fs_absence_start_date,'X') AND v_absence_start_date_chk='Y') 
	THEN
	   UPDATE RAC_FS_TM_EMPLOYEE_UPD
	...
	IF (COALESCE(v_absence_end_date,'X') != COALESCE(v_fs_absence_end_date,'X') AND v_absence_end_date_chk='Y') 
	THEN
	   UPDATE RAC_FS_TM_EMPLOYEE_UPD
